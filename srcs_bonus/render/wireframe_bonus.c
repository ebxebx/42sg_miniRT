...
static void	put_wire_pixel(t_mlx *mlx, int x, int y, int color)
{
...
static void	draw_sphere(t_scene *scene, t_sp sphere, int color)
{
	...
	draw_circle(scene, sphere.centre, vec3_init(1, 0, 0), sphere.radius, color);
	draw_circle(scene, sphere.centre, vec3_init(0, 1, 0), sphere.radius, color);
}
